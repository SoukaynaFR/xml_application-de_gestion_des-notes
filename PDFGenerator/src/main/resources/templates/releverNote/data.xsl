            ...
            <fo:layout-master-set>
             ...
             <fo:page-sequence master-reference="simpleA4">         
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <fo:block background-color="white" margin-top="0px" border-style="solid" padding-after="8pt" padding-before="8pt" margin-bottom="8pt" border-width="1px">
                        <fo:block font-weight="bold" font-family="Times New Roman" font-style="normal" text-align="center" margin-bottom="3pt">
                            UNIVERSITE ABDELMALEK ESSAEDI
                        </fo:block>
                        <fo:block font-weight="bold" font-family="Times New Roman" font-style="normal" text-align="center" margin-bottom="3pt">
                            Ecole Nationale des Sciences Appliquées de Tanger
                        </fo:block>
                        <fo:block font-weight="bold" font-family="Times New Roman" font-style="normal" text-align="center">
                    ...
                    <fo:block   padding-after="8pt" padding-before="8pt" margin-bottom="8pt" >
                        <fo:block  font-weight="bold" font-family="Times New Roman">
						...
						<fo:block text-align="center" margin-bottom="10pt" padding-bottom="4pt" font-weight="bold" font-family="Times New Roman">
                    ...
                    <fo:table border-style="solid" inline-progression-dimension="auto" table-layout="fixed" width="100%" border-width="0.5px">
						...
						<fo:table-body>
						    <fo:table-row text-align="center" background-color="white">
						        <fo:table-cell padding="8pt" border-width="0.5px" border-style="solid" font-weight="bold"><fo:block>MODULE</fo:block></fo:table-cell>
						        <fo:table-cell  padding="8pt" border-width="0.5px" border-style="solid" font-weight="bold"><fo:block>MOYENNE</fo:block></fo:table-cell>
							    <fo:table-cell padding="8pt" border-width="0.5px" border-style="solid" font-weight="bold"><fo:block>RESULTAT</fo:block></fo:table-cell>
							    <fo:table-cell padding="8pt" border-width="0.5px" border-style="solid" font-weight="bold"><fo:block>SESSION </fo:block></fo:table-cell>
                            </fo:table-row>
						    <fo:table-row>
						        <fo:table-cell padding="2pt" border-width="0.5px" border-style="solid">
						    ...
						    <fo:table-row>
						        <fo:table-cell padding="1pt" border-width="0.5px" border-style="solid">
						            <fo:block text-align="center">
                    ...
                    <fo:block text-align="center" margin-top="8pt" border-style="solid" padding-after="8pt" padding-before="8pt" margin-bottom="8pt" border-width="1px">
                        <fo:block font-family="Times New Roman" font-weight="bold" margin-bottom="8pt">
                    ...
                    <fo:block>
                        ...
                        <fo:block text-align="right" margin-bottom="10pt" padding-bottom="4pt">
