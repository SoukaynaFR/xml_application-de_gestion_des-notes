                        ...
                        <fo:table-body>
                            <fo:table-row>
                                <fo:table-cell width="3cm" height="1cm" margin-right="0.8cm">
                                    <fo:block font-family="Times New Roman" font-size="2.5px" color="#02306E" text-align="center" margin-top="0.19cm" margin-bottom="0.02cm" >
                                        <xsl:value-of select="c:nameMinFr1"/>
                                    </fo:block>
                                    <fo:block font-family="Times New Roman" font-size="2.5px" color="#02306E" text-align="center"  margin-bottom="0.02cm">
                                ...
                                <fo:table-cell width="1cm" >
                                    <xsl:if test="c:logoMin">
                                        <fo:block margin-top="0.1cm" margin-left="-0.33cm">
                                            <fo:external-graphic 
                                                src="carteEtudiant/back/logo-maroc.png" 
                                ...
                                <fo:table-cell width="3.3cm" height="1cm" margin-right="1cm">
                                    <fo:block font-family="Naskh" font-size="4.3px"
                                ...
                                <fo:table-cell width="1.5cm" height="1cm" margin-right="0.8cm">  
                                    <fo:block width="1.5cm" margin-left="0.5cm" margin-top="0.1cm" >
                                        <fo:instream-foreign-object>
                                            <svg width="69" height="52" viewBox="0 0 201 162" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <xsl:if test="c:EngageIcon">
                                        <fo:block margin-top="-1.77cm" margin-left="0.9cm" >
                                            <fo:external-graphic 
                                                src="carteEtudiant/back/engag.png" 
                                                content-height="scale-to-fit"
                                                content-width="scale-to-fit"
                                                width="0.45cm"
                                                height="0.45cm"
                                    ...
                                    <fo:block height =" 0.5cm" font-family="Sans-serif" font-size="2.5px" font-weight="bold"
                                ...
                                <fo:table-cell width="1.5cm" height="1cm" margin-right="0.8cm">  
                                    ...
                                    <xsl:if test="c:EspritEqIcon">
                                        <fo:block margin-top="-1.73cm" margin-left="0.88cm" >
                                            <fo:external-graphic 
                                                src="carteEtudiant/back/EsEQ.png" 
                                                content-height="scale-to-fit"
                                                content-width="scale-to-fit"
                                                width="0.4cm"
                                                height="0.3cm"
                                ...
                                <fo:table-cell width="1.5cm" height="1cm" margin-right="0.8cm">  
                                    ...
                                    <xsl:if test="c:EspritInIcon">
                                        <fo:block margin-top="-1.73cm" margin-left="0.79cm">
                                            <fo:external-graphic 
                                                src="carteEtudiant/back/ESIN.png" 
                                                content-height="scale-to-fit"
                                                content-width="scale-to-fit"
                                                width="0.3cm"
                                                height="0.3cm"
                                ...
                                <fo:table-cell width="1.5cm" height="1cm" margin-right="0.8cm">  
                                    ...
                                    <xsl:if test="c:TransIcon">
                                        <fo:block margin-top="-1.86cm" margin-left="0.45cm" >
                                            <fo:external-graphic 
                                                src="carteEtudiant/back/trans.png" 
                                                content-height="scale-to-fit"
                                                content-width="scale-to-fit"
                                                width="0.8cm"
                                                height="0.55cm"
