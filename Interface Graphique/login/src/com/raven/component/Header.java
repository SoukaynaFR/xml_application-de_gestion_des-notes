...
public class Header extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(159, 206, 234));

        imageAvatar1.setBorderSize(1);
        imageAvatar1.setBorderSpace(0);
        imageAvatar1.setImage(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/profile-image.png"))); // NOI18N
