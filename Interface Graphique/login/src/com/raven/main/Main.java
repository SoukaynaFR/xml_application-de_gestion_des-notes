...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/logo-ensa.png"))); // NOI18N

        cmdSignIn.setBackground(new java.awt.Color(11, 167, 205));
        cmdSignIn.setForeground(new java.awt.Color(255, 255, 255));
        cmdSignIn.setText("Se Connecter");
        cmdSignIn.setEffectColor(new java.awt.Color(229, 233, 245));
        ...
        txtUser.setLabelText("Nom d'Utlisateur");
        txtUser.setLineColor(new java.awt.Color(11, 167, 205));
        txtUser.setSelectionColor(new java.awt.Color(159, 206, 234));

        txtPass.setBackground(new java.awt.Color(245, 245, 245));
        txtPass.setLabelText("Mot de Passe");
        txtPass.setLineColor(new java.awt.Color(11, 167, 205));
        txtPass.setSelectionColor(new java.awt.Color(159, 206, 234));
    ...
    private void cmdSignInActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdSignInActionPerformed
        if (!animatorLogin.isRunning()) {
            ...
            boolean action = true;
            if (user.isEmpty()) {
                txtUser.setHelperText("Veuillez saisir le nom d'utilisateur !");
                txtUser.grabFocus();
                action = false;
            }
            // This is pretty much the most important part:
            if (pass.isEmpty()) {
                txtPass.setHelperText("Veuillez saisir le mot de passe !");
                if (action) {
                    txtPass.grabFocus();
                }
                action = false;
            ...
            if ((!pass.equals("xml-admin") && !pass.isEmpty()) || (!user.equals("xml-admin") && !pass.isEmpty())) {
                txtPass.setHelperText("Le nom d'utilisateur ou mot de passe est incorect!");
                if (action) {
                    txtPass.grabFocus();
                }
                action = false;
